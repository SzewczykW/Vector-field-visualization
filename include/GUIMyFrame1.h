...
class GUIMyFrame1 : public MyFrame1 {
	...
	/**
	 * @brief Method for repainting the window
	 * 
	*/
	void Repaint ();

	/**
	 * @brief Destroy the GUIMyFrame1 object
	 * 
	 */
	~GUIMyFrame1 ();
	private:
	/**
	 * @brief Pointer to CoordinateSystem object
	 * 
	 */
	CoordinateSystem* _CoordinateSystem;

	/**
	 * @brief wxImage for saving the image
	 * 
	 */
	wxImage _imageSave;

	/**
	 * @brief wxBitmap for saving the image
	 * 
	 */
